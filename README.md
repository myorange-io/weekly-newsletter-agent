...
| 7 | [발행 담당](agents/07-publisher.md) | 확정 원고를 채널별 포맷으로 바꾼다 | 회차별 |
| 8 | [재시도 담당](agents/08-retrier.md) | **기다리면 되는가** — 일시 실패를 시간으로 살린다 | 1시간 |
| 9 | [정비공](agents/09-maintainer.md) | **코드를 고쳐야 하는가** — 진단하고 패치를 제안한다 | 주 1회 |
